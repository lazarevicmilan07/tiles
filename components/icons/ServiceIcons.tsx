import { ServiceIcon } from "@/data/services";
...
function DropletsIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function ServiceIconComponent({ icon, className = "w-8 h-8" }: { icon: ServiceIcon; className?: string }) {
  const icons: Record<ServiceIcon, JSX.Element> = {
    grid: <GridIcon className={className} />,
    wrench: <WrenchIcon className={className} />,
    droplets: <DropletsIcon className={className} />,
    hammer: <HammerIcon className={className} />,
